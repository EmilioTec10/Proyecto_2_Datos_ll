...
Pac_Man::Pac_Man()
{
    ...
    connect(socket_timer, SIGNAL(timeout()),this,SLOT(inSocket()));
    socket_timer->start(55);
...
/*
void Pac_Man::inSocket() {
    if (vel->segundoDato[0]== '7'){
        direcction = 'U';
        cycle = 0;
        timer_animation_D->stop();
        timer_animation_L->stop();
